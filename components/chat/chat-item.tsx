...
export const ChatItem = ({
  ...
  const isImage = !isPDF && content.slice(0, 5) === "https" && fileType;

  return (
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
      <div className="group flex gap-x-2 items-start w-full">
        <div className="cursor-pointer flex gap-x-2 hover:drop-shadow-md transition w-full">
          ...
          <div className="flex flex-col w-full ">
            ...
            {isImage && (
              <a
                ...
                className="relative aspect-squar rounded-md mt-2 overflow-hidden
            ...
            {isPDF && (
              <div
                className="relative flex ites-center p-2 mt-2 rounded-md
                 bg-background/10 "
              >
                <FileIcon
